...
impl BuildHandler for Animations {
    ...
    fn on_build(&mut self, state: &mut State, entity: Entity) -> Self::Ret {
        ...
        self.element = Element::new().build(state, container, |builder| builder.class("element"));
        ...
        self.background_color_button =
            Button::with_label("Background Color").build(state, vbox, |builder| builder);
        ...
        self.border_button =
            Button::with_label("Border Width").build(state, vbox, |builder| builder);
        ...
        self.border_radius_button =
            Button::with_label("Border Radius").build(state, vbox, |builder| builder);
